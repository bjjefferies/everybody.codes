...
set names vector to temp vector
break codes apart into L/R and spaces
Same algorithm for movement as above
final index - pull name and assign to names[1], names[1] -> names[index]
